...
int main()
{
  ...
  std::cout << "Created object back, with the name \"" << list.createObject_back("first!!111!")->GetName() << std::endl;
  std::cout << "Created object back, with the name \"" << list.createObject_back("second!!1!!")->GetName() << std::endl;
